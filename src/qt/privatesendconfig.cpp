...
void PrivateSendConfig::clickBasic()
{
    ...
    QMessageBox::information(this, tr("PrivateSend Configuration"),
        tr(
            "PrivateSend was successfully set to basic (%1 and 2 rounds). You can change this at any time by opening mtap's configuration screen.")
            .arg(strAmount));
...
void PrivateSendConfig::clickHigh()
{
    ...
    QMessageBox::information(this, tr("PrivateSend Configuration"),
        tr(
            "PrivateSend was successfully set to high (%1 and 8 rounds). You can change this at any time by opening mtap's configuration screen.")
            .arg(strAmount));
...
void PrivateSendConfig::clickMax()
{
    ...
    QMessageBox::information(this, tr("PrivateSend Configuration"),
        tr(
            "PrivateSend was successfully set to maximum (%1 and 16 rounds). You can change this at any time by opening mtap's configuration screen.")
            .arg(strAmount));
...
void PrivateSendConfig::configure(bool enabled, int coins, int rounds)
{
    ...
    settings.setValue("nAnonymizemtapAmount", coins);

    nPrivateSendRounds = rounds;
    nAnonymizemtapAmount = coins;
}
