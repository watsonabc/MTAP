                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MTAP Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MTAP Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about MTAP Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for mtap"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the MTAP Coin Core help message to get a list with possible mtap command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MTAP Coin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("MTAP Coin Core"); // default title
