...
public:
	...
	hashGenesisBlock = genesis.GetHash();
        ...
        strPrivateSendPoolDummyAddress = "MJ4HhEc82t4x3y3zKcfaLyBnDsu5nSe94P";
...
*/
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet mtap addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet mtap script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet mtap BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet mtap BIP32 prvkeys start with 'DRKP'
...
public:
    CRegTestParams()
    {
        ...
        nTargetSpacing = 1 * 60;        // mtap: 1 minutes
