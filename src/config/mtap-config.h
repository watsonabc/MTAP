/* src/config/mtap-config.h.  Generated from mtap-config.h.in by configure.  */
/* src/config/mtap-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MTAP_CONFIG_H

#define MTAP_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.mtap.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MTAP Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MTAP Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "MTAP"
