...
// this bearable tinyformat comes with a set of mmtapos which are used
// internally to generate the API, but which may also be used in user code.
//
// The three mmtapos TINYFORMAT_ARGTYPES(n), TINYFORMAT_VARARGS(n) and
// TINYFORMAT_PASSARGS(n) will generate a list of n argument types,
// type/name pairs and argument names respectively when called with an integer
// n between 1 and 16.  We can use these to define a mmtapo which generates the
// desired user defined function with n arguments.  To generate all 16 user
// defined function bodies, use the mmtapo TINYFORMAT_FOREACH_ARGNUM.  For an
...
// To keep it as transparent as possible, the mmtapos below have been generated
...
// C++98 - define the interface functions using the wrapping mmtapos
...
//------------------------------------------------------------------------------
// Define deprecated wrapping mmtapo for backward compatibility in tinyformat
