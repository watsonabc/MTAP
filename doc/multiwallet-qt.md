...
In order to support loading of multiple wallets in mtap-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mtap.cpp.
...
Changes to mtap.cpp
----------------------
mtap.cpp is the entry point into mtap-qt, and as such, will require some minor modifications to provide hooks for
