...
git clone https://github.com/mtap-crypto/mtap.git
cd mtap
...
```bash
    ...
    From https://github.com/mtap-crypto/mtap
...
For example:
```bash
URL=https://github.com/crowning-/mtap.git
...
[mtap/gitian.sigs](https://github.com/mtap-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
